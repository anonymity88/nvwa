...
if __name__ == "__main__":
    ...
    plt = plot_branch_coverage(plt,timestamps, covered_lines, taken_branches, "MLIRSmith")

    log_file_path = '/home/workdir/tracer/fuzz_tool/data/ablation/coverage_0805rt_cov.log'  # 日志文件路径
    timestamps, covered_lines, taken_branches = parse_log_file(log_file_path)
    plt = plot_branch_coverage(plt,timestamps, covered_lines, taken_branches, "MLIRod")
    ...
    log_file_path = '/home/workdir/tracer/fuzz_tool/data/ablation/coverage_0805rt_cov.log'  # 日志文件路径
    timestamps, covered_lines, taken_branches = parse_log_file(log_file_path)
    plt = plot_branch_coverage(plt,timestamps, covered_lines, taken_branches, "Tracer (NNSmith seeds)")

    log_file_path = '/home/workdir/tracer/fuzz_tool/data/ablation/coverage_0805rt_cov.log'  # 日志文件路径
    timestamps, covered_lines, taken_branches = parse_log_file(log_file_path)
    plt = plot_branch_coverage(plt,timestamps, covered_lines, taken_branches, "Tracer (MLIRSmith seeds)")

    log_file_path = '/home/workdir/tracer/fuzz_tool/data/ablation/coverage_0805rt_cov.log'  # 日志文件路径
    timestamps, covered_lines, taken_branches = parse_log_file(log_file_path)
    plt = plot_branch_coverage(plt,timestamps, covered_lines, taken_branches, "Tracer (MLIRod seeds)")
