module {
  ...
  func.func @main(%A: memref<2x2xf32>, %B: memref<2x2xf32>, %C: memref<2x2xf32>, %val0: i32, %private_arg: i32) -> (f32, i32, i32) {
    ...
    call @minimal_while() : () -> ()
    return %reduction_result, %while_result, %private_result : f32, i32, i32
  }
}