module {
  func.func @main(%input_pad: tensor<2x3xf32>, 
    ...
    // Maximum and select operations with SCF if
    ...
    return %pad_result, %loop_result, %sin_result, %cond_result, %cos_result, %scf_result : 
           tensor<6x7xf32>, tensor<*xi32>, tensor<?x?xf32>, tensor<4xf32>, tensor<4xf32>, tensor<4xf32>
  }
}