...
module {
  func.func @main() -> vector<2x2xf32> {
    ...
    // Create async group for first two copies
    %token1 = nvgpu.device_async_create_group %cp1, %cp2

    // Third async copy operation
    ...
    // Create async group for third copy
    %token2 = nvgpu.device_async_create_group %cp3

    // Load matrix operation
