module {
  ...
  func.func @main(%buffer1: memref<100xf32>, %buffer2: memref<100xf32>,
                  ...
                  %cond: i1, %t1: tensor<?xf32>, %v1: vector<5xf32>,
                  %v2: vector<5xf32>, %v3: vector<5xf32>, %idx: index,
                  %cond2: i1, %private_arg: i32) 
                  -> (f32, f32, memref<128xi32>, i64, tensor<?xf32>, i32) {
    ...
    %tensor_result = call @scf_if_inplace6(%t1, %v1, %v2, %v3, %idx, %cond, %cond2) :
                     (tensor<?xf32>, vector<5xf32>, vector<5xf32>, vector<5xf32>, index, i1, i1) -> tensor<?xf32>
    %private_result = call @private2(%private_arg) : (i32) -> i32
    return %sum, %product, %processed, %cond_result, %tensor_result, %private_result : 
           f32, f32, memref<128xi32>, i64, tensor<?xf32>, i32
  }
}