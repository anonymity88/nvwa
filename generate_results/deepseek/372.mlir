module {
  ...
  irdl.dialect @main {
    irdl.operation @entry_point {
      %example_op = irdl.is @example::@op_with_regions
      %cmath_op = irdl.is @cmath::@combined_operation
      %testd_op = irdl.is @testd::@any
      irdl.operands(%example_op, %cmath_op, %testd_op)
      irdl.results()
    }
  }
}