module {
  ...
  func.func @main(
  ...
  ) -> (tensor<4xi32>, tensor<16x4xf32>, tensor<1x?xf32>, tensor<256x128x16x32xf32>) {
    ...
    return %bitcasted, %slice1, %slice2, %packed : tensor<4xi32>, tensor<16x4xf32>, tensor<1x?xf32>, tensor<256x128x16x32xf32>
  }
}