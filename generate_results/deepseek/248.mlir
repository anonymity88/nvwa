module {
  ...
  func.func @main(%input_sinh: f64, %input_round: f64, %input_asinh: f64, %input_tanh: f32) -> (f64, f64, f64, f32) {
    ...
    %tanh_result = call @tanh(%input_tanh) : (f32) -> f32
    
    return %sinh_result, %round_result, %asinh_result, %tanh_result : f64, f64, f64, f32
  }
}