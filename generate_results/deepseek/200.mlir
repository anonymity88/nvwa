module {
  ...
  func.func @main(%source: tensor<1x2xf32>, %dest: tensor<4x4x4xf32>, %indices: tensor<1x2x3xi32>, %m1: index, %n1: index, %m2: index, %n2: index) -> (tensor<8x16xf32>, tensor<?x20x?xf32>, tensor<?x?xf32>, tensor<4x4x4xf32>) {
    ...
    return %static_splat, %dynamic_splat, %generated_tensor, %scattered_tensor : tensor<8x16xf32>, tensor<?x20x?xf32>, tensor<?x?xf32>, tensor<4x4x4xf32>
  }
}