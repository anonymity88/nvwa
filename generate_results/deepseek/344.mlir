module {
  func.func @main(
    ...
    // Call inotequal_vector function
    %inequality_result = call @inotequal_vector(%arg0, %arg1) : (vector<4xi32>, vector<4xi32>) -> vector<4xi1>

    return %image_result, %image_vector_result, %log_result, %log_vector_result, %log_vector_h16_result, %sdiv_result, %sdiv_vector_result, %inequality_result : 
           !spirv.image<f32, Cube, NoDepth, NonArrayed, SingleSampled, NoSampler, Unknown>,
           !spirv.image<f32, Cube, NoDepth, NonArrayed, SingleSampled, NoSampler, Unknown>,
           f32,
           vector<4xf32>,
