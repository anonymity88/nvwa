module {
  ...
  func.func @main(%input_sin: f64, %input_asin: f64, %input_log: f64, %input_f8: f8E5M2) -> (f64, f64, f64, f8E5M2) {
    ...
    %f8_result = call @sin_f8E5M2(%input_f8) : (f8E5M2) -> f8E5M2
    
    return %sin_result, %asin_result, %log_result, %f8_result : f64, f64, f64, f8E5M2
  }
}