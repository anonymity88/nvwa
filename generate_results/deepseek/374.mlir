...
module {
  ...
  func.func @main(
    ...
    %I: memref<?x?xindex>, 
    %J: memref<?x?xindex>,
    %tensor_in: tensor<32x4x32x8xf32>,
    %tensor_out: tensor<128x256xf32>
  ) -> (tensor<1x26x26x8xi32>, tensor<128x256xf32>) {
    ...
    %unpack_result = call @CKkc_to_KC(%tensor_in, %tensor_out) : (tensor<32x4x32x8xf32>, tensor<128x256xf32>) -> tensor<128x256xf32>
    
    return %quant_result, %unpack_result : tensor<1x26x26x8xi32>, tensor<128x256xf32>
  }
}